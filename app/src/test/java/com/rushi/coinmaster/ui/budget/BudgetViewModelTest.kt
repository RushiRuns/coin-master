...
class BudgetViewModelTest {
    ...
    fun setUp() {
        ...
        viewModel = BudgetViewModel(context, budgetRepository, validateZeroBalanceUseCase, expenseCategoryRepository, incomeStreamRepository, accountRepository, addTransactionUseCase)
    }
